            ...
            <div class="card">
              ...
              <form role="form" action="<?=site_url('stock/process')?>" method="post">
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label>Info *</label>
                                <input type="text" class="form-control" name="detail" placeholder="Kerusakan / hilang / kedaluarsa / etc" required>
                            </div>
                            <div class="form-group">
                                <label>Qty *</label>
                ...
                <div class="card-footer text-center">
                    ...
                    <button type="submit" name="out_add" class="btn btn-success"><i class="fa-regular fa-paper-plane"></i> Save</button>
                </div>
              </form>
            </div>
        </div>
