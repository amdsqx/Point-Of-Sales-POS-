...
class User extends CI_Controller {
    ...
    public function edit($id)   
    {
        ...
        // untuk membatasi index, jika index db tidak ditemukan maka tidak valid dan dikembalikan ke data user
        if ($this->form_validation->run() == FALSE) {
    ...
    // untuk mengecek data, jika user_id sudah ada maka diharuskan ganti
